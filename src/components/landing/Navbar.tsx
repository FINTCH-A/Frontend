...
export default function Navbar() {
  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-100 py-5 px-8 md:px-16 transition-all duration-300 ${
        scrolled
    ...
    >
      <div className="flex items-center justify-between">
        <Link href="/" className="text-2xl font-bold tracking-tight text-foreground no-underline">
          Avante<span className="text-primary">Fintech</span>
        </Link>
        ...
        <ul className="hidden md:flex gap-8 list-none items-center">
          ...
          <li><a href="#contacto" className="text-muted-foreground text-sm hover:text-primary transition-colors">Contáctanos</a></li>
